 ...
 * @var app\models\BodyCountScore $bcs
 */

 $this->title = 'Catatan BCS';
                    ...
                    <div class="card-content">
                        <div class="card-body cage-form">
                            ...
                            <form class="form" method="post">
                                ...
                                <div class="form-body">
                                    <?= $form->field($bcs, 'name')->textInput(['maxlength' => true]) ?>
                                    <?= $form->field($bcs, 'location')->textInput(['maxlength' => true]) ?>
                                    <?= $form->field($bcs, 'description')->textarea(['rows' => 6]) ?>
                                </div>
